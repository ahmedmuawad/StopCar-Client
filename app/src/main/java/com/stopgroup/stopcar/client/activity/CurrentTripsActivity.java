...
import com.stopgroup.stopcar.client.adapter.CurrentTripsAdapter;
...
public class CurrentTripsActivity extends AppCompatActivity {
    ...
    CurrentTripsAdapter resultsAdapter;
    ...
    public void initView() {
        ...
        resultsAdapter = new CurrentTripsAdapter(this, results);
        ...
        titleTxv.setText(R.string.current_trips);
    }
    ...
    public void listeners() {
        ...
        getResults(CurrentTripsActivity.this, paginatorData);
    }
    ...
    public void getResults(final Activity activity, final PaginatorData paginator) {
        ...
        APIModel.getMethod(activity, "client/current/trips", new TextHttpResponseHandler() {
            @Override
