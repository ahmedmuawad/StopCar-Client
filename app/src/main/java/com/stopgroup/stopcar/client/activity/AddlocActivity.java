...
public class AddlocActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener {
    ...
    private void initView() {
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(AddlocActivity.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
        if (ActivityCompat.checkSelfPermission(AddlocActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            // : Consider calling
...
// move the camera zoom to the location
    ...
    private void onclick() {
        ...
        Confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (lat.equals("")) {
                    Dialogs.showToast(getString(R.string.desi), AddlocActivity.this);
                } else {
                    makeorder();
                }
    ...
    private void makeorder() {
        ...
        APIModel.postMethod(AddlocActivity.this, "client_places", requestParams, new TextHttpResponseHandler() {
            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {

                APIModel.handleFailure(AddlocActivity.this, statusCode, responseString, new APIModel.RefreshTokenListener() {
                    @Override
