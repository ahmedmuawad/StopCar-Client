...
public class Gdata {
    ...
    public static Companies.ResultBean CompaniesResultBean;
    ...
    public static void getAddress1(Double lat, Double lon, final TextView data) {
        ...
        client.get("https://maps.googleapis.com/maps/api/geocode/json?latlng=" + lat + ","
                + lon + "&key=AIzaSyCJTFD3_ou87p7961rq7ao_Wwp7S7E_VPM&language=" + Locale.getDefault().getLanguage(), new TextHttpResponseHandler() {
            @Override
