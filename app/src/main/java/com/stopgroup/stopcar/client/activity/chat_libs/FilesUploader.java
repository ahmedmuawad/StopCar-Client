...
import static com.stopgroup.stopcar.client.activity.chat_libs.Libs.getFile;
public class FilesUploader {
    public interface OnImageUploadListener {
        void OnImageUploaded(String file);
        void OnError();
    }
    public FilesUploader(Context context, Uri file, String folder, String extention, final OnImageUploadListener onImageUploadListener) {
        ...
        try {
            String uid =  "chat" ;
            StorageReference path = FirebaseStorage.getInstance().getReference(folder).child(uid).child(System.currentTimeMillis() + extention);
